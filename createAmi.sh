...
sed -e 's;##aws_access_key_id##;'$AWS_ACCESS_KEY_ID';g' -e 's;##aws_secret_access_key##;'$AWS_SECRET_ACCESS_KEY';g' .docker-build-ami_REPLACE.conf > .docker-build-ami.conf
...
echo "AMI: $AMI"
# aws ec2 modify-image-attribute --image-id $AMI --profile build --launch-permission "Add=[{UserId=890129220607}, {UserId=681044435084}]"